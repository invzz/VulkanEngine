...
- Practically: you still need _performance_ controls (culling, max lights per tile/cluster, shadow budgets).
...
Even if you allow _unlimited_ lights, you usually cannot afford _unlimited shadow maps_.
