...
namespace engine::test {
  ...
  protected:
    ...
    std::unique_ptr<DescriptorPool> createFreeablePool(uint32_t maxSets, VkDescriptorType type) { return createPool(maxSets, type, VK_DESCRIPTOR_POOL_CREATE_FREE_DESCRIPTOR_SET_BIT); }
  };
  ...
  protected:
    ...
    DescriptorSetLayout& layout() { return *layout_; }
    DescriptorPool&      pool() { return *pool_; }

    VkDescriptorSetLayout layoutHandle() { return layout_->getDescriptorSetLayout(); }
