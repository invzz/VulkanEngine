...
TEST(DescriptorWriter, AllocationFallbackWhenPoolFull)
{
  Window window(1, 1, "DWF");
  Device device(window);

  // Primary pool limited to a single set, enable overflow fallback.
  ...
  // Small buffer for descriptor writes
  VkBuffer       buf;
