...
public:
    ...
    uint32_t getSelectedObjectId() const { return selectedObjectId_; }
    ...
    entt::entity getActiveCameraEntity() const { return activeCameraEntity_; }
    ...
    int getThemePreset() const { return themePreset_; }
    ...
    LayoutPreset getLayoutPreset() const { return layoutPreset_; }
    ...
    void setFrameTimeMs(float ms) { frameTimeMs_ = ms; }
