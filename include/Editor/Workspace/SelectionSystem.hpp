...
public:
     ...
     */
    const std::set<entt::entity>& getSelection() const { return selection_; }
     ...
     */
    entt::entity getActiveSelection() const { return activeSelection_; }
     ...
     */
    size_t getSelectionCount() const { return selection_.size(); }
