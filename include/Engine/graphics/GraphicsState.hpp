 ...
 */
     ...
     */
        ...
        [[nodiscard]] ShadowSystem* shadowSystem() const {
            return shadowSystem_.get();
        }
        [[nodiscard]] LightSystem* lightSystem() const {
            return lightSystem_.get();
        }
        [[nodiscard]] SkyboxRenderSystem* skyboxRenderSystem() const {
            return skyboxRenderSystem_.get();
        }
        [[nodiscard]] GridRenderSystem* gridRenderSystem() const {
            return gridRenderSystem_.get();
        }
        [[nodiscard]] DeferredLightingSystem* deferredLightingSystem() const {
            return deferredLightingSystem_.get();
        }
        [[nodiscard]] PostProcessingSystem* postProcessingSystem() const {
            return postProcessingSystem_.get();
        }
        [[nodiscard]] IBLSystem* iblSystem() const {
            return iblSystem_.get();
        }
        [[nodiscard]] PhysicsSystem* physicsSystem() const {
            return physicsSystem_.get();
        }
        [[nodiscard]] JoltPhysicsSystem* joltPhysicsSystem() const {
            return joltPhysicsSystem_.get();
        }
        [[nodiscard]] AnimationSystem* animationSystem() const {
            return animationSystem_.get();
        }
        [[nodiscard]] ColliderDebugRenderSystem* colliderDebugRenderSystem() const {
            return colliderDebugRenderSystem_.get();
        }
        ...
        [[nodiscard]] Scene* scenePtr() {
            return &scene_;
        }
        [[nodiscard]] entt::entity& selectedEntity() {
            return selectedEntity_;
        }
        [[nodiscard]] entt::entity& cameraEntity() {
            return cameraEntity_;
        }
        [[nodiscard]] Skybox* skybox() const {
            return skybox_.get();
        }
        [[nodiscard]] std::unique_ptr<Skybox>& skyboxRef() {
            return skybox_;
        }
        [[nodiscard]] SkyboxSettings& skySettings() const {
            return skySettings_;
        }
        ...
        [[nodiscard]] bool showDebugObjects() const {
            return showDebugObjects_;
        }
        [[nodiscard]] bool& showDebugObjectsRef() {
            return showDebugObjects_;
        }
        [[nodiscard]] bool showColliderWireframes() const {
            return showColliderWireframes_;
        }
        [[nodiscard]] bool& showColliderWireframesRef() {
            return showColliderWireframes_;
        }
        [[nodiscard]] bool debugMode() const {
            return debugMode_;
        }
        [[nodiscard]] bool& debugModeRef() {
            return debugMode_;
        }
        [[nodiscard]] bool physicsSimulationRunning() const {
            return physicsSimulationRunning_;
        }
        [[nodiscard]] bool& physicsSimulationRunningRef() {
            return physicsSimulationRunning_;
        }
        [[nodiscard]] bool solidGroundEnabled() const {
