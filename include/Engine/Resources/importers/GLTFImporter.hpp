...
public:
  bool load(Model::Builder &builder, const std::string &filepath, bool flipX,
            bool flipY, bool flipZ) override;
...
private:
  ...
  void loadMaterials(Model::Builder &builder, const tinygltf::Model &model,
                     const std::string &baseDir, const std::string &cacheDir);

  void
  loadMeshes(Model::Builder &builder, const tinygltf::Model &model, bool flipX,
  ...
  void loadMorphTargets(
      Model::Builder &builder, const tinygltf::Model &model,
  ...
  glm::mat4 computeNodeTransform(const tinygltf::Node &node) const;

  void
  processMesh(Model::Builder &builder, const tinygltf::Model &model,
              int meshIndex, const glm::mat4 &globalTransform,
