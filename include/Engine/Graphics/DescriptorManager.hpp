...
public:
    ...
    // G-buffer
    [[nodiscard]] DescriptorPool& gbufferPool() const { return *gbufferPool_; }
    [[nodiscard]] DescriptorSetLayout& gbufferSetLayout() const { return *gbufferSetLayout_; }
    ...
    // Deferred IBL
    [[nodiscard]] DescriptorPool& deferredIblPool() const { return *deferredIblPool_; }
    [[nodiscard]] DescriptorSetLayout& deferredIblSetLayout() const { return *deferredIblSetLayout_; }
    ...
    // Deferred Shadow
    [[nodiscard]] DescriptorPool& deferredShadowPool() const { return *deferredShadowPool_; }
    [[nodiscard]] DescriptorSetLayout& deferredShadowSetLayout() const { return *deferredShadowSetLayout_; }
    ...
    // Post-processing
    [[nodiscard]] DescriptorPool& postProcessPool() const { return *postProcessPool_; }
    [[nodiscard]] DescriptorSetLayout& postProcessSetLayout() const { return *postProcessSetLayout_; }
