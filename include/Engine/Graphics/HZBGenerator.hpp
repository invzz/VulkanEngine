...
public:
  ...
  void recreateDescriptors(FrameBuffer &frameBuffer, VkExtent2D extent,
                           uint32_t framesInFlight);

  void generate(VkCommandBuffer commandBuffer, FrameBuffer &frameBuffer,
                VkExtent2D extent, int frameIndex);
