...
namespace engine {
  ...
  public:
    ...
    [[nodiscard]] VkDescriptorSetLayout getShadowDescriptorSetLayout() const { return shadowDescriptorSetLayout_; }
    [[nodiscard]] VkDescriptorSetLayout getIBLDescriptorSetLayout() const { return iblDescriptorSetLayout_; }
