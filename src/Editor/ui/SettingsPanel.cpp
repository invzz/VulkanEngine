...
namespace engine {
    ...
    void SettingsPanel::render(FrameInfo& frameInfo) {
        ...
        if (ui::UI::Section("Performance")) {
            ...
            if (ui::UI::InputInt("Recording threads (0 = auto)##perf_threads", &tmpThreads)) {
            ...
            if ((rendering.modelRenderSystem != nullptr) && ui::UI::ResetButton("Reset Material Cache Stats##perf_reset")) {
        ...
        if (ui::UI::Section("Shader Variants (Week 10)")) {
            if (rendering.modelRenderSystem == nullptr) {
                ...
                static const char*           variantItems[] = {"Auto", "Force Standard", "Force Full"};
                if (ui::UI::Combo("Variant Policy##shader_variant", &variantPolicy, variantItems, 3)) {
        ...
        if (ui::UI::Section("Logging")) {
            ...
            static const char*           levelItems[] = {"Error", "Warn", "Info", "Debug"};
            if (ui::UI::Combo("Minimum Level##log_level", &minLevel, levelItems, 4)) {
