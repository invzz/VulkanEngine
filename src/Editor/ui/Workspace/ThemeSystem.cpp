...
namespace engine {
    ...
    ImVec4 ThemeSystem::getAccentColor() const {
        switch (currentPreset_) {
            case 0:
                return DARK_CHECK_MARK;
            case 1:
                return LIGHT_CHECK_MARK;
            case 2:
                return MIDNIGHT_CHECK_MARK;
            default:
                return DARK_CHECK_MARK;
        }
    }
    ...
    ImVec4 ThemeSystem::getDisabledColor() const {
        switch (currentPreset_) {
            case 0:
                return DARK_TEXT_DISABLED;
            case 1:
                return LIGHT_TEXT_DISABLED;
            case 2:
                return MIDNIGHT_TEXT_DISABLED;
            default:
                return DARK_TEXT_DISABLED;
        }
    }
    ...
    ImVec4 ThemeSystem::getSeparatorColor() const {
        switch (currentPreset_) {
            case 0:
                return DARK_SEPARATOR;
            case 1:
                return LIGHT_SEPARATOR;
            case 2:
                return MIDNIGHT_SEPARATOR;
            default:
                return DARK_SEPARATOR;
        }
    }
